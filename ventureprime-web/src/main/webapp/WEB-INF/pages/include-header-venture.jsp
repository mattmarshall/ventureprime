...
<jsp:include page="include-header.jsp" />
                <div style="width: 1000px">
                    <div>
                        <div class="ui-corner-top ui-state-default" style="display: inline-block; padding: 5px; border-color: gray; border-style: solid; border-width: 1px 1px 0px 1px; margin-right:5px; float:right">My Account</div>
